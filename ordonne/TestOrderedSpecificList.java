...
public class TestOrderedSpecificList {
	...
	public static void main(String[] args) {
		...
		sls.addValue("test30");
		sls.addValue("test70");
		System.out.println("OrderedSpecificList<String> : "+sls.getSize());
		...
		System.out.println("End OrderedSpecificList<String>");
		
		OrderedSpecificList<Personne> slp = new OrderedSpecificList<Personne> ();
		...
		System.out.println("OrderedSpecificList<Personne> : "+slp.getSize());
